...
- Never edit `SHORTCUTS.md` by hand; `scripts/shortcuts.sh` regenerates it on
  every config load — reload tmux to refresh it after changing bindings
...
- Shortcut reference: `SHORTCUTS.md` (generated by `scripts/shortcuts.sh`)
